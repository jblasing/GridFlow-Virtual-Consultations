...
<tr><td style="padding:20px 30px;color:#71808c;font-size:12px;line-height:1.7">If a button does not open, <a href="${safeChecklistUrl}" style="color:#d94a16;font-weight:700">click here for the checklist</a> or <a href="${safeManageUrl}" style="color:#d94a16;font-weight:700">click here to manage your appointment</a>.</td></tr>
